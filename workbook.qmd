...
2. Male care tends to restrict the invasion of alleles that code for inbreeding, relative to no male care conditions. See the fraction of lines that fall below the dashed, black control line in Figure 3. 

3. Male care reduces the invasion prospects of inbreeding alleles, irrespective of the sex they are expressed in.

4. However, when care has a large mitigating effect on inbreeding depression (large $\alpha$), the conditions for inbreeding alleles to invade become more permissive, even when males invest quite a lot in care. For example, when care reduces inbreeding depression by 75%, and males lose half a future outbred mating, the invasion prospects of an inbreeding strategy are equivalent to the no male care condition (where substantial inbreeding depression can be tolerated).   
